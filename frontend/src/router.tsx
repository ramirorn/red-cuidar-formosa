    ...
    { path: '/', element: conCarga(<InicioPublico />), errorElement: <ErrorRuta /> },
    {
        ...
        children: [
            { path: 'escanear', element: conCarga(<Escaner />) },
            {
                ...
                errorElement: <ErrorRuta />,
                children: [
                    { index: true, element: conCarga(<InicioVecino />), handle: { ancho: 'amplio' } },
                    { path: 'reportar', element: conCarga(<Reportar />), handle: { titulo: 'Nuevo reporte', volverA: '/app' } },
                    { path: 'enviado', element: conCarga(<Enviado />), handle: { titulo: 'Reporte guardado', volverA: '/app', directo: true } },
                    { path: 'limpieza', element: conCarga(<Limpieza />), handle: { titulo: 'Ya limpié', volverA: '/app' } },
                    { path: 'reportes', element: conCarga(<MisReportes />) },
                    { path: 'mapa', element: conCarga(<MapaBarrio />), handle: { ancho: 'completo' } },
