...
export const ESTADOS_REPORTE: Record<EstadoReporte, { etiqueta: string; clases: string; Icono: typeof Clock }> = {
...
export const ChipEstadoReporte = ({ estado, className }: { estado: EstadoReporte; className?: string }) => {
